...
const style: React.CSSProperties = {
    ...
    WebkitMask: "radial-gradient(var(--overlay-radius) var(--overlay-radius) at var(--overlay-x) var(--overlay-y), white 1%, transparent 50%)",
}
export default function HoverGlowEffectOverlay() {
    ...
    return (
    <div aria-hidden={true} className='overlay dark-bg-white bg-teal-700 fixed inset-0 pointer-events-none select-none' style={style} ref={div}>
    </div>)
}